...
import { fetchProfileById, fetchStatuses, deleteProfile } from '@/lib/apiClient';
...
import { AlertTriangle, Edit, Trash2, Loader2, ArrowLeft } from 'lucide-react';
...
function ProfileDetailsPageContent() {
    ...
    const { data: profile, isLoading: isLoadingProfile, error: profileError } = useQuery({
        ...
        enabled: !!id && !isLoadingStatuses, // Only fetch if id is available and statuses are loaded
    });
    ...
    const isLoading = isLoadingProfile || isLoadingStatuses || deleteMutation.isPending;
            ...
            <Card className="w-full max-w-2xl mx-auto shadow-md">
                ...
                <CardContent className="space-y-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-4">
                        ...
                        <div>
                            <p className="text-sm font-medium text-muted-foreground">Caste/Raise</p>
                        ...
                        <div>
                            <p className="text-sm font-medium text-muted-foreground">Star Match Score</p>
