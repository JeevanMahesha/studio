...
import { updateProfile, fetchProfileById, fetchStatuses } from '@/lib/apiClient';
...
const ProfileUpdateSchema = ProfileSchema.omit({ id: true, createdAt: true, updatedAt: true });
...
function EditProfilePageContent() {
    ...
    const { data: profile, isLoading: isLoadingProfile, error: profileError } = useQuery({
        ...
        enabled: !!id && !isLoadingStatuses, // Fetch only when id and statuses are available
    });

    // Mutation for updating the profile
    const mutation = useMutation({
        mutationFn: (updatedData: ProfileUpdateData) => updateProfile(id, updatedData),
        onSuccess: (data) => {
            if (data) {
                toast({
    ...
    const isLoading = isLoadingProfile || isLoadingStatuses;
